...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            mnemnk::agent::flow::add_agent_edge_cmd,
            mnemnk::agent::flow::delete_agent_edge_cmd,
            mnemnk::agent::flow::add_agent_node_cmd,
            mnemnk::agent::flow::delete_agent_node_cmd,
